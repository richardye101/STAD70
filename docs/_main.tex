...
We have a fitted mean \(\mu\) of \ensuremath{3.2242702\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4635324\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615321\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827254\times 10^{-4}}.
