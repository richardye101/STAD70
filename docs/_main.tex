...
We have a fitted mean \(\mu\) of \ensuremath{3.2241562\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634667\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615323\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827258\times 10^{-4}}.
