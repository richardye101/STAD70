...
\begin{verbatim}
##                  date adj_close
## 1 2015-01-02 14:30:00  44.17997
...
We have a fitted mean \(\mu\) of \ensuremath{3.2240305\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4635072\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.661531\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827268\times 10^{-4}}.
