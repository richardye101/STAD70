...
We have a fitted mean \(\mu\) of \ensuremath{3.2239368\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634446\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615324\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.382727\times 10^{-4}}.
