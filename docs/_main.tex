...
We have a fitted mean \(\mu\) of \ensuremath{3.2240775\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4635453\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615329\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827254\times 10^{-4}}.
