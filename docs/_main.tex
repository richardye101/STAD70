...
We have a fitted mean \(\mu\) of \ensuremath{3.2240769\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634737\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615322\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827248\times 10^{-4}}.
