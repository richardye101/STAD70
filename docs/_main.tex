...
We can use PCA to identify components
...
We have a fitted mean \(\mu\) of \ensuremath{3.2239324\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634822\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.661532\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827244\times 10^{-4}}.
