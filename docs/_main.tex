...
## 3 2015-01-06 14:30:00  42.38908
...
We have a fitted mean \(\mu\) of \ensuremath{3.2240439\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4635868\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615327\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827267\times 10^{-4}}.
