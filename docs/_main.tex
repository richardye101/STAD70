...
We have a fitted mean \(\mu\) of \ensuremath{3.224037\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634975\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615334\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827262\times 10^{-4}}.
