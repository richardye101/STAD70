...
We have a fitted mean \(\mu\) of \ensuremath{3.223997\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4636026\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615317\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827263\times 10^{-4}}.
