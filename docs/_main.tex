...
We have a fitted mean \(\mu\) of \ensuremath{3.2241203\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634992\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615334\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827281\times 10^{-4}}.
