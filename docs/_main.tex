...
We have a fitted mean \(\mu\) of \ensuremath{3.223931\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634692\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615327\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827258\times 10^{-4}}.
