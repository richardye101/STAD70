...
We have a fitted mean \(\mu\) of \ensuremath{3.2240868\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634962\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615321\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827263\times 10^{-4}}.
...
0.055 &= 14.2379w^{2} -19.2379 w + 11\\
0 &= 14.2379w^{2} -19.2379 w + 11 - 5.5\\
w &= 0.4108 \text{ and } 0.9404
\end{aligned}
\]

\%\%(19.2379 - (19.2379\textsuperscript{2-4\emph{14.2379}(11-5.5))}0.5)/(2*14.2379) = 0.41077491441024704384
0.9404004696000353714\%\%
...
5^{2}\% &= (1-w_{f})^{2}\cdot 7\%\\
\frac{.25\%}{7\%} &= 1-2w_{f}+w_{f}^{2}\\
0 &= w_{f}^{2}-2w_{f}+1 - \frac{.25\%}{7\%}\\
0 &= w_{f}^{2}-2w_{f}+ \frac{6.75\%}{7\%}\\
\end{aligned}
\]
Using the quadratic formula I get:
(2 + (2\^{}2 - 4*(0.0675/0.07))\^{}0.5)/(2) = 1.1889 and 0.8110

But the solutions states:
2/7 = 0.2857 in risk-free, 0.4643 in C, and 0.2500 in D

\begin{quote}
I have no idea how. Can't spot my mistake :\\
\end{quote}
