...
We have a fitted mean \(\mu\) of \ensuremath{3.2240458\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4635079\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615339\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.3827282\times 10^{-4}}.
