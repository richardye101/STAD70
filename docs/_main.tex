...
We have a fitted mean \(\mu\) of \ensuremath{3.22413\times 10^{-4}} and variance \(\sigma^{2}\) of \ensuremath{1.4634805\times 10^{-4}}.
This is compared to the sample mean \(\mu\) of \ensuremath{5.6615324\times 10^{-4}} and variance \(\sigma^2\) of \ensuremath{1.382726\times 10^{-4}}.
